...
public class ShadowActivity extends ShadowContextWrapper {
	 ...
	 *             if the {@code contentView} has not been called first
	 */
	@Implementation
	 ...
	 * {@link com.xtremelabs.robolectric.tester.android.view.TestWindow}) if no
	 * window has previously been set.
	 * 
	 ...
	 * 
	 * @throws RuntimeException
	 *             if any listeners are still registered
	...
	/**
	 * Checks the {@code ApplicationContext} to see if {@code BroadcastListener}
	 * s are still registered.
	 * 
	 * @throws RuntimeException
	 *             if any listeners are still registered
	 * @see ShadowApplication#assertNoBroadcastListenersRegistered(android.content.Context,
	 *      String)
	 */
	 ...
	 * 
	 * @return the {@code contentView} set by one of the
	 *         {@code setContentView()} methods
	 */
	 ...
	 * Non-Android accessor.
	 * 
	 * @return the {@code resultCode} set by one of the {@code setResult()}
	 *         methods
	 */
	 ...
	 * Non-Android accessor.
	 * 
	 * @return the {@code Intent} set by
	 *         {@link #setResult(int, android.content.Intent)}
	 */
	 ...
	 * 
	 * @return the next started {@code Intent} for an activity, wrapped in an
	 *         {@link ShadowActivity.IntentForResult} object
	 */
	 ...
	 * consuming it.
	 * 
	 * @return the most recently started {@code Intent}, wrapped in an
	 *         {@link ShadowActivity.IntentForResult} object
	 */
	...
	/**
	 * Container object to hold an Intent, together with the requestCode used in
	 * a call to {@code Activity#startActivityForResult(Intent, int)}
	 */
	...
	public void receiveResult(Intent requestIntent, int resultCode, Intent resultIntent) {
		...
		try {
			Method method = Activity.class.getDeclaredMethod("onActivityResult", Integer.TYPE, Integer.TYPE,
					Intent.class);
